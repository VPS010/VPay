              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6 text-left" action="#">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label className="text-gray-500">
                          Input only the fildes you want to update (leave other
                          fields blank){" "}
                        </label>
                      </div>
                    </div>
                  ...
                  <button
                    ...
                    className=" mx-2 w-full  text-white mt-0 px-5 mb-2 bg-[#1cabdfd4] hover:bg-[#4ba0bf] focus:ring-2 focus:outline-none focus:bg-[#1cabdfa4] font-medium rounded-lg  py-2 text-center"
                  >
                    UPDATE
                  </button>
                </form>
